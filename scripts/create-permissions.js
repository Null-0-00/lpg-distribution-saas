...
async function createPermissions() {
  try {
    ...
    const defaultPermissions = [
      ...
      { name: 'manage_inventory', description: 'Manage inventory and stock levels' },
      { name: 'manage_drivers', description: 'Manage driver information and assignments' },
      { name: 'manage_expenses', description: 'Create and approve expenses' },
      { name: 'manage_receivables', description: 'Manage customer receivables' },
      { name: 'view_reports', description: 'Access financial and business reports' },
