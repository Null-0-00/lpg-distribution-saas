...
const englishTranslations: Translations = {
  ...
  receivableRecords: 'প্রাপ্য রেকর্ড',
  ...
  changeInReceivablesCashCylinders: 'প্রাপ্য (নগদ ও সিলিন্ডার) পরিবর্তন',
  ...
  enterCurrentReceivablesForEachDriver: 'প্রতিটি চালকের বর্তমান প্রাপ্য লিখুন',
...
const bengaliTranslations: Translations = {
  ...
  changes: 'পরিবর্তন',
  loadingReceivables: 'প্রাপ্য লোড হচ্ছে',
  ...
  receivablesChangesLog: 'প্রাপ্য পরিবর্তন লগ',
  ...
  emptyCylinderInventoryAndReceivables: 'খালি সিলিন্ডার মজুদ এবং প্রাপ্য',
  ...
  totalDepositsCalculated: 'গণনা করা মোট জমা',
  noExpensesFound: 'কোনো খরচ পাওয়া যায়নি।',
  totalExpensesCalculated: 'মোট খরচ গণনা করা',
  ...
  totalDiscountLabel: 'মোট ছাড়',
  netValueLabel: 'নেট মূল্য',
  cashReceivableWarning: 'নগদ প্রাপ্য সতর্কবাণী',
  customerNameRecommended: 'গ্রাহকের নাম (প্রস্তাবিত)',
  cylinderReceivableWarning: 'সিলিন্ডার প্রাপ্য সতর্কবাণী',
  ...
  movementAnomaly: 'চলাচলে অস্বাভাবিকতা',
  operationSuccessful: 'অপারেশন সফল হয়েছে।',
  welcomeToOnboarding: 'স্বাগতম করতে অনবোর্ডিং',
  setupYourBusinessData: 'সেটআপ আপনার ব্যবসায়িক তথ্য',
  companyNames: 'কোম্পানির নাম',
  productSetup: 'পণ্য সেটআপ',
  inventoryQuantities: 'মজুদ পরিমাণ',
  driversSetup: 'চালক সেটআপ',
  receivablesSetup: 'প্রাপ্য সেট করুনউপরে',
  skipOnboarding: 'অনবোর্ডিং এড়িয়ে যান',
  completing: 'সম্পন্ন হচ্ছে...',
  completeSetup: 'সম্পূর্ণ সেট করুনউপরে',
  setupBusiness: 'সেটআপ ব্যবসায়িক',
  addCompanyNames: 'যোগ করুন কোম্পানি নাম',
  addCompaniesYouDistributeFor: 'যোগ করুন কোম্পানি আপনি বিতরণ জন্য',
  addNewCompany: 'যোগ করুন নতুন কোম্পানি',
  enterCompanyNamesLikeAygaz: 'কোম্পানির নাম লিখুন (যেমন, আয়গাজ)',
  companyName: 'কোম্পানি নাম',
  enterCompanyName: 'প্রবেশ করান কোম্পানি নাম',
  companyNameRequired: 'কোম্পানি নাম হয় প্রয়োজনীয়',
  ...
  setupProductsAndSizes: 'পণ্য এবং মাপ সেটআপ করুন',
  configureCylinderSizesAndProducts: 'সিলিন্ডারের মাপ ও পণ্য কনফিগার করুন',
  addCylinderSize: 'যোগ করুন সিলিন্ডার আকার',
  addSizesLike12L20L: 'মাপ যোগ করুন, যেমন ১২লি ২০লি',
  enterSizeLike12L: 'মাপ লিখুন (যেমন, ১২লি)',
  addSize: 'যোগ করুন আকার',
  cylinderSizeRequired: 'সিলিন্ডার আকার হয় প্রয়োজনীয়',
  cylinderSizeAlreadyExists: 'সিলিন্ডার আকার ইতিমধ্যে বিদ্যমান',
  enterDescription: 'প্রবেশ করান বিবরণ',
  addProduct: 'যোগ করুন পণ্য',
  addNewProduct: 'যোগ করুন নতুন পণ্য',
  addProductsForEachCompany: 'যোগ করুন পণ্য জন্য প্রতিটি কোম্পানি',
  productName: 'পণ্য নাম',
  enterProductName: 'প্রবেশ করান পণ্য নাম',
  enterProductNameExample: 'পণ্যের নাম লিখুন (উদাহরণ...)',
  currentPrice: 'বর্তমান দাম',
  enterPrice: 'প্রবেশ করান দাম',
  productNameRequired: 'পণ্য নাম হয় প্রয়োজনীয়',
  validPriceRequired: 'বৈধ দাম হয় প্রয়োজনীয়',
  productAlreadyExists: 'পণ্য ইতিমধ্যে বিদ্যমান',
  addedProducts: 'যোগ করা পণ্যসমূহ',
  addCylinderSizesAndProducts: 'যোগ করুন সিলিন্ডার আকার এবং পণ্য',
  bothRequiredToProceed: 'উভয় করতে এগিয়ে যান হয় প্রয়োজনীয়',
  setInitialInventory: 'সেট করুন প্রাথমিক মজুদ',
  enterCurrentFullCylinderQuantities: 'বর্তমান ভরা সিলিন্ডারের পরিমাণ লিখুন',
  fullCylinderInventory: 'পূর্ণ সিলিন্ডার মজুদ',
  enterQuantityForEachProduct: 'প্রবেশ করান পরিমাণ জন্য প্রতিটি পণ্য',
  noProductsAvailable: 'কোনো পণ্য উপলব্ধ নেই।',
  addProductsFirst: 'যোগ করুন পণ্য প্রথম',
  ...
  enterQuantityForEachSize: 'প্রবেশ করান পরিমাণ জন্য প্রতিটি আকার',
  noCylinderSizesAvailable: 'কোন সিলিন্ডার আকার উপলব্ধ',
  addCylinderSizesFirst: 'যোগ করুন সিলিন্ডার আকার প্রথম',
  totalSizes: 'মোট আকার',
  totalEmptyCylinders: 'মোট খালি সিলিন্ডার',
  emptyCylinderNote: 'খালি সিলিন্ডার নোট',
  addYourDrivers: 'যোগ করুন আপনার চালক',
  addDriversWhoWillSellProducts: 'যোগ করুন চালক যারা করবে বিক্রয় পণ্য',
  enterDriverInformation: 'প্রবেশ করান চালক তথ্য',
  enterDriverName: 'প্রবেশ করান চালক নাম',
  shipmentDriver: 'চালান চালক',
  driverNameRequired: 'চালক নাম হয় প্রয়োজনীয়',
  driverAlreadyExists: 'চালক ইতিমধ্যে বিদ্যমান',
  addedDrivers: 'যোগ করা চালকগণ',
  driversInYourTeam: 'আপনার দলের চালকগণ',
  noContactInfo: 'না যোগাযোগ তথ্য',
  noDriversAdded: 'কোনো চালক যোগ করা হয়নি।',
  addAtLeastOneDriver: 'কমপক্ষে একজন চালক যোগ করুন',
  setupReceivables: 'সেট করুনউপরে প্রাপ্য',
  enterCurrentReceivablesForEachDriver: 'প্রতিটি চালকের বর্তমান প্রাপ্য লিখুন',
  driverReceivables: 'চালক প্রাপ্য',
  enterCashAndCylinderReceivables: 'প্রবেশ করান নগদ এবং সিলিন্ডার প্রাপ্য',
  amountOwedByCustomers: 'পরিমাণ পাওনা দ্বারা গ্রাহক',
  cylindersOwedByCustomers: 'গ্রাহকদের কাছে পাওনা সিলিন্ডার',
  cylindersOwedByCustomersBySize: 'মাপ অনুযায়ী গ্রাহকদের কাছে পাওনা সিলিন্ডার',
  noDriversAvailable: 'কোনো চালক উপলব্ধ নেই।',
  addDriversFirst: 'যোগ করুন চালক প্রথম',
  noRetailDriversAvailable: 'কোনো খুচরা চালক উপলব্ধ নেই।',
  addRetailDriversFirst: 'যোগ করুন খুচরা চালক প্রথম',
  receivablesSummary: 'প্রাপ্য সারসংক্ষেপ',
