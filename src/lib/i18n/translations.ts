...
export interface Translations {
  ...
  customerAndAreaManagement: string;
  manageAreasCustomersAndAutomatedMessaging: string;
  automatedMessagingEnabled: string;
  automatedCustomerMessagingWorkflow: string;
  createAndManageAreasForGeographicalOrganization: string;
  addCustomersToAreasWithPhoneNumbers: string;
  updateCustomerReceivablesMessagesAutomaticallySent: string;
  whatsappSmsNotificationsSentOnReceivablesChange: string;

  // Area Management Tab
  areaManagement: string;
  organizeCustomersByGeographicalAreas: string;
  addArea: string;
  editArea: string;
  createFirstArea: string;
  noAreasFound: string;
  createYourFirstAreaToOrganizeCustomers: string;
  addNewArea: string;
  areaName: string;
  areaCode: string;
  activeArea: string;
  areaNameRequired: string;
  cannotDeleteAreaWithCustomers: string;
  confirmDeleteArea: string;
  areaCreatedSuccessfully: string;
  areaUpdatedSuccessfully: string;
  areaDeletedSuccessfully: string;
  failedToFetchAreas: string;
  failedToSaveArea: string;
  failedToDeleteArea: string;
  editAreaTooltip: string;
  deleteAreaTooltip: string;
  areaNamePlaceholder: string;
  areaCodePlaceholder: string;
  optionalDescriptionForArea: string;

  // Customer Management Tab
  customerManagementTab: string;
  addAndManageCustomers: string;
  addCustomer: string;
  editCustomer: string;
  noCustomersFound: string;
  createYourFirstCustomerToStartTracking: string;
  ...
  failedToSaveCustomer: string;
  failedToDeleteCustomer: string;

  // Customer Management Interface
  customerManagementTitle: string;
  manageCustomersOrganizedByGeographicalAreas: string;
  selectAreaFirst: string;
  chooseAreaToViewAndManageCustomers: string;
  selectAnArea: string;
  selectAnAreaTitle: string;
  pleaseSelectAreaFirstToViewCustomers: string;
  searchCustomersCodesPhones: string;
  allTypes: string;
  activeOnly: string;
  inactiveOnly: string;
  showingCustomersInArea: string;
  noMatchingCustomers: string;
  addFirstCustomerToGetStarted: string;
  tryAdjustingSearchOrFilter: string;
  ...
  optionalAssignDriverToServeCustomer: string;
  autoGeneratedIfEmpty: string;
  requiredForAutomatedMessaging: string;
  alternatePhone: string;

  // Customer Receivables Tab
  customerReceivables: string;
  updateCustomerReceivables: string;
  trackAndUpdateCustomerOutstandingBalances: string;
  summary: string;
  apply: string;
  customer: string;
  records: string;
  ...
  configureAutomatedMessages: string;
  messagingConfiguration: string;
  whatsappSettings: string;
  receivablesUpdates: string;
  paymentConfirmations: string;
  cylinderReturnConfirmations: string;
  smsSettings: string;
  backupMessaging: string;
  bangladeshProviders: string;
  configured: string;
  messageTemplates: string;
  bengaliEnglish: string;
  messagingSystemStatus: string;
  allMessagingServicesConfiguredAndRunning: string;

  // Messaging Log translations
  failedToFetchMessageLogs: string;
  failedToLoadMessageLogs: string;
  confirmDeleteMessageLog: string;
  failedToDeleteMessage: string;
  receivablesChange: string;
  cylinderReturn: string;
  errorLoadingMessageLogs: string;
  messageLog: string;
  filters: string;
  searchByPhoneOrMessage: string;
  triggerType: string;
  allTriggers: string;
  allStatuses: string;
  ...
  // Messaging Metrics translations
  failedToFetchMessagingMetrics: string;
  failedToLoadMetrics: string;
  errorLoadingMetrics: string;
  noMessagingMetricsAvailable: string;
  messagingMetrics: string;
  previousMonth: string;
  monthlyChange: string;
  vsLastMonth: string;
  messagesByType: string;
  messagesByStatus: string;
...
const englishTranslations: Translations = {
  ...
  // Customer Management Page
  customerAndAreaManagement: 'Customer & Area Management',
  manageAreasCustomersAndAutomatedMessaging:
    'Manage areas, customers, and automated messaging for receivables',
  automatedMessagingEnabled: 'Automated messaging enabled',
  automatedCustomerMessagingWorkflow: 'Automated Customer Messaging Workflow',
  createAndManageAreasForGeographicalOrganization:
    'Create and manage areas for geographical organization',
  addCustomersToAreasWithPhoneNumbers:
    'Add customers to areas with phone numbers for messaging',
  updateCustomerReceivablesMessagesAutomaticallySent:
    'Update customer receivables - messages are sent automatically',
  whatsappSmsNotificationsSentOnReceivablesChange:
    'WhatsApp/SMS notifications sent when receivables change',
  ...
  createYourFirstAreaToOrganizeCustomers:
  ...
  failedToFetchAreas: 'Failed to fetch areas',
  failedToSaveArea: 'Failed to save area',
  failedToDeleteArea: 'Failed to delete area',
  editAreaTooltip: 'Edit area',
  deleteAreaTooltip: 'Delete area',
  areaNamePlaceholder: 'e.g., Dhanmondi, Gulshan, Uttara',
  areaCodePlaceholder: 'e.g., DH, GS, UT',
  optionalDescriptionForArea: 'Optional description for this area',

  // Customer Management Tab
  customerManagementTab: 'Customer Management',
  addAndManageCustomers: 'Add and manage customers',
  addCustomer: 'Add Customer',
  editCustomer: 'Edit Customer',
  noCustomersFound: 'No Customers Found',
  createYourFirstCustomerToStartTracking:
    'Create your first customer to start tracking sales and receivables.',
  ...
  selectAnAreaTitle: 'Select an Area',
  pleaseSelectAreaFirstToViewCustomers:
    'Please select an area first to view and manage customers.',
  searchCustomersCodesPhones: 'Search customers, codes, phones...',
  allTypes: 'All Types',
  activeOnly: 'Active Only',
  inactiveOnly: 'Inactive Only',
  showingCustomersInArea: 'Showing {count} of {total} customers in {area}',
  noMatchingCustomers: 'No Matching Customers',
  addFirstCustomerToGetStarted: 'Add your first customer to get started.',
  ...
  requiredForAutomatedMessaging: 'Required for automated messaging',
  alternatePhone: 'Alternate Phone',

  // Customer Receivables Tab
  customerReceivables: 'Customer Receivables',
  updateCustomerReceivables: 'Update customer receivables',
  trackAndUpdateCustomerOutstandingBalances:
    'Track and update customer outstanding balances',
  summary: 'Summary',
  apply: 'Apply',
  customer: 'Customer',
  records: 'Records',
  ...
  configureAutomatedMessages: 'Configure automated messages',
  messagingConfiguration: 'Messaging Configuration',
  whatsappSettings: 'WhatsApp Settings',
  receivablesUpdates: 'Receivables Updates',
  paymentConfirmations: 'Payment Confirmations',
  cylinderReturnConfirmations: 'Cylinder Return Confirmations',
  smsSettings: 'SMS Settings',
  backupMessaging: 'Backup Messaging',
  bangladeshProviders: 'Bangladesh Providers',
  configured: 'Configured',
  messageTemplates: 'Message Templates',
  bengaliEnglish: 'Bengali/English',
  messagingSystemStatus: 'Messaging System Status',
  allMessagingServicesConfiguredAndRunning:
    'All messaging services are configured and running. Messages are automatically sent when customer receivables are updated, payments are received, or cylinders are returned. Customer phone numbers are required to receive notifications.',

  // Messaging Log translations
  failedToFetchMessageLogs: 'Failed to fetch message logs',
  failedToLoadMessageLogs: 'Failed to load message logs',
  confirmDeleteMessageLog: 'Are you sure you want to delete this message log?',
  failedToDeleteMessage: 'Failed to delete message',
  receivablesChange: 'Receivables Change',
  cylinderReturn: 'Cylinder Return',
  errorLoadingMessageLogs: 'Error loading message logs',
  messageLog: 'Message Log',
  filters: 'Filters',
  searchByPhoneOrMessage: 'Search by phone or message',
  ...
  message: 'Message',
  sentAt: 'Sent At',
  deleteMessageLog: 'Delete Message Log',
  showing: 'Showing',
  messages: 'Messages',
  page: 'Page',

  // Messaging Metrics translations
  failedToFetchMessagingMetrics: 'Failed to fetch messaging metrics',
  failedToLoadMetrics: 'Failed to load metrics',
  errorLoadingMetrics: 'Error loading metrics',
  noMessagingMetricsAvailable: 'No messaging metrics available',
  messagingMetrics: 'Messaging Metrics',
  previousMonth: 'Previous Month',
  monthlyChange: 'Monthly Change',
  vsLastMonth: 'vs Last Month',
  messagesByType: 'Messages by Type',
  messagesByStatus: 'Messages by Status',
...
const bengaliTranslations: Translations = {
  ...
  // Customer Management Page
  customerAndAreaManagement: 'গ্রাহক ও এলাকা ব্যবস্থাপনা',
  manageAreasCustomersAndAutomatedMessaging:
    'এলাকা, গ্রাহক এবং বকেয়ার জন্য স্বয়ংক্রিয় বার্তা ব্যবস্থাপনা করুন',
  automatedMessagingEnabled: 'স্বয়ংক্রিয় বার্তা সক্রিয়',
  automatedCustomerMessagingWorkflow: 'স্বয়ংক্রিয় গ্রাহক বার্তা কর্মপ্রবাহ',
  createAndManageAreasForGeographicalOrganization:
    'ভৌগোলিক সংগঠনের জন্য এলাকা তৈরি এবং পরিচালনা করুন',
  addCustomersToAreasWithPhoneNumbers:
    'বার্তা পাঠানোর জন্য ফোন নম্বর সহ এলাকায় গ্রাহক যোগ করুন',
  updateCustomerReceivablesMessagesAutomaticallySent:
    'গ্রাহক বকেয়া আপডেট করুন - বার্তা স্বয়ংক্রিয়ভাবে পাঠানো হয়',
  whatsappSmsNotificationsSentOnReceivablesChange:
    'বকেয়া পরিবর্তনের সময় হোয়াটসঅ্যাপ/এসএমএস বিজ্ঞপ্তি পাঠানো হয়',

  // Area Management Tab
  areaManagement: 'এলাকা ব্যবস্থাপনা',
  organizeCustomersByGeographicalAreas:
    'ভৌগোলিক এলাকা অনুযায়ী গ্রাহকদের সংগঠিত করুন',
  addArea: 'এলাকা যোগ করুন',
  editArea: 'এলাকা সম্পাদনা করুন',
  createFirstArea: 'প্রথম এলাকা তৈরি করুন',
  noAreasFound: 'কোনো এলাকা পাওয়া যায়নি',
  createYourFirstAreaToOrganizeCustomers:
    'গ্রাহকদের ভৌগোলিকভাবে সংগঠিত করতে আপনার প্রথম এলাকা তৈরি করুন।',
  addNewArea: 'নতুন এলাকা যোগ করুন',
  areaName: 'এলাকার নাম',
  areaCode: 'এলাকার কোড',
  activeArea: 'সক্রিয় এলাকা',
  areaNameRequired: 'এলাকার নাম প্রয়োজন',
  cannotDeleteAreaWithCustomers:
    'গ্রাহক সহ এলাকা মুছে ফেলা যাবে না। অনুগ্রহ করে প্রথমে গ্রাহকদের সরান বা মুছে ফেলুন।',
  confirmDeleteArea: 'আপনি কি নিশ্চিত যে এই এলাকা মুছে ফেলতে চান?',
  areaCreatedSuccessfully: 'এলাকা সফলভাবে তৈরি হয়েছে',
  areaUpdatedSuccessfully: 'এলাকা সফলভাবে আপডেট হয়েছে',
  areaDeletedSuccessfully: 'এলাকা সফলভাবে মুছে ফেলা হয়েছে',
  failedToFetchAreas: 'এলাকা আনতে ব্যর্থ হয়েছে',
  failedToSaveArea: 'এলাকা সংরক্ষণ করতে ব্যর্থ হয়েছে',
  failedToDeleteArea: 'এলাকা মুছে ফেলতে ব্যর্থ হয়েছে',
  editAreaTooltip: 'এলাকা সম্পাদনা করুন',
  deleteAreaTooltip: 'এলাকা মুছে ফেলুন',
  areaNamePlaceholder: 'যেমন, ধানমন্ডি, গুলশান, উত্তরা',
  areaCodePlaceholder: 'যেমন, DH, GS, UT',
  optionalDescriptionForArea: 'এই এলাকার জন্য ঐচ্ছিক বিবরণ',

  // Customer Management Tab
  customerManagementTab: 'গ্রাহক ব্যবস্থাপনা',
  addAndManageCustomers: 'গ্রাহক যোগ এবং পরিচালনা করুন',
  addCustomer: 'গ্রাহক যোগ করুন',
  editCustomer: 'গ্রাহক সম্পাদনা করুন',
  noCustomersFound: 'কোনো গ্রাহক পাওয়া যায়নি',
  createYourFirstCustomerToStartTracking:
    'বিক্রয় এবং বকেয়া ট্র্যাক করা শুরু করতে আপনার প্রথম গ্রাহক তৈরি করুন।',
  ...
  industrial: 'শিল্প',
  activeCustomer: 'সক্রিয় গ্রাহক',
  customerNameRequired: 'গ্রাহকের নাম প্রয়োজন',
  confirmDeleteCustomer: 'আপনি কি নিশ্চিত যে এই গ্রাহক মুছে ফেলতে চান?',
  customerCreatedSuccessfully: 'গ্রাহক সফলভাবে তৈরি হয়েছে',
  customerUpdatedSuccessfully: 'গ্রাহক সফলভাবে আপডেট হয়েছে',
  customerDeletedSuccessfully: 'গ্রাহক সফলভাবে মুছে ফেলা হয়েছে',
  failedToFetchCustomers: 'গ্রাহক আনতে ব্যর্থ হয়েছে',
  failedToSaveCustomer: 'গ্রাহক সংরক্ষণ করতে ব্যর্থ হয়েছে',
  failedToDeleteCustomer: 'গ্রাহক মুছে ফেলতে ব্যর্থ হয়েছে',

  // Customer Management Interface
  customerManagementTitle: 'গ্রাহক ব্যবস্থাপনা',
  manageCustomersOrganizedByGeographicalAreas:
    'ভৌগোলিক এলাকা অনুযায়ী সংগঠিত গ্রাহকদের পরিচালনা করুন',
  selectAreaFirst: 'প্রথমে এলাকা নির্বাচন করুন *',
  chooseAreaToViewAndManageCustomers:
    'সেই অঞ্চলের গ্রাহকদের দেখতে এবং পরিচালনা করতে একটি এলাকা নির্বাচন করুন',
  selectAnArea: 'একটি এলাকা নির্বাচন করুন...',
  selectAnAreaTitle: 'একটি এলাকা নির্বাচন করুন',
  pleaseSelectAreaFirstToViewCustomers:
    'গ্রাহকদের দেখতে এবং পরিচালনা করতে অনুগ্রহ করে প্রথমে একটি এলাকা নির্বাচন করুন।',
  searchCustomersCodesPhones: 'গ্রাহক, কোড, ফোন অনুসন্ধান করুন...',
  allTypes: 'সব ধরন',
  activeOnly: 'শুধুমাত্র সক্রিয়',
  inactiveOnly: 'শুধুমাত্র নিষ্ক্রিয়',
  showingCustomersInArea:
    '{area} এ {total} এর মধ্যে {count} গ্রাহক দেখানো হচ্ছে',
  noMatchingCustomers: 'কোনো মিলে যাওয়া গ্রাহক নেই',
  addFirstCustomerToGetStarted: 'শুরু করতে আপনার প্রথম গ্রাহক যোগ করুন।',
  ...
  receivable: 'পাওনা',
  areaRequired: 'এলাকা *',
  assignDriver: 'চালক বরাদ্দ করুন',
  noDriverAssigned: 'কোনো চালক বরাদ্দ করা হয়নি',
  optionalAssignDriverToServeCustomer:
    'ঐচ্ছিক - এই গ্রাহকের সেবা করার জন্য একজন চালক বরাদ্দ করুন',
  autoGeneratedIfEmpty: 'খালি থাকলে স্বয়ংক্রিয়ভাবে তৈরি হবে',
  requiredForAutomatedMessaging: 'স্বয়ংক্রিয় বার্তার জন্য প্রয়োজন',
  alternatePhone: 'বিকল্প ফোন',

  // Customer Receivables Tab
  customerReceivables: 'গ্রাহক পাওনা',
  updateCustomerReceivables: 'গ্রাহক পাওনা আপডেট করুন',
  trackAndUpdateCustomerOutstandingBalances:
    'গ্রাহকের পাওনা ব্যালেন্স ট্র্যাক এবং আপডেট করুন',
  summary: 'সারসংক্ষেপ',
  apply: 'প্রয়োগ করুন',
  customer: 'গ্রাহক',
  records: 'রেকর্ড',
  ...
  // Messaging Settings Tab
  messagingSettings: 'মেসেজিং সেটিংস',
  configureAutomatedMessages: 'স্বয়ংক্রিয় মেসেজ কনফিগার করুন',
  messagingConfiguration: 'বার্তা কনফিগারেশন',
  whatsappSettings: 'হোয়াটসঅ্যাপ সেটিংস',
  receivablesUpdates: 'বকেয়া আপডেট',
  paymentConfirmations: 'পেমেন্ট নিশ্চিতকরণ',
  cylinderReturnConfirmations: 'সিলিন্ডার ফেরত নিশ্চিতকরণ',
  smsSettings: 'এসএমএস সেটিংস',
  backupMessaging: 'ব্যাকআপ বার্তা',
  bangladeshProviders: 'বাংলাদেশ প্রোভাইডার',
  configured: 'কনফিগার করা',
  messageTemplates: 'বার্তা টেমপ্লেট',
  bengaliEnglish: 'বাংলা/ইংরেজি',
  messagingSystemStatus: 'বার্তা সিস্টেমের অবস্থা',
  allMessagingServicesConfiguredAndRunning:
    'সকল বার্তা সেবা কনফিগার করা এবং চালু আছে। গ্রাহকের বকেয়া আপডেট হলে, পেমেন্ট পেলে, বা সিলিন্ডার ফেরত দিলে স্বয়ংক্রিয়ভাবে বার্তা পাঠানো হয়। বিজ্ঞপ্তি পেতে গ্রাহকদের ফোন নম্বর প্রয়োজন।',

  // Messaging Log translations
  failedToFetchMessageLogs: 'মেসেজ লগ আনতে ব্যর্থ',
  failedToLoadMessageLogs: 'মেসেজ লগ লোড করতে ব্যর্থ',
  confirmDeleteMessageLog: 'আপনি কি নিশ্চিত যে এই মেসেজ লগ মুছে ফেলতে চান?',
  failedToDeleteMessage: 'মেসেজ মুছতে ব্যর্থ',
  receivablesChange: 'পাওনা পরিবর্তন',
  cylinderReturn: 'সিলিন্ডার ফেরত',
  errorLoadingMessageLogs: 'মেসেজ লগ লোড করতে ত্রুটি',
  messageLog: 'মেসেজ লগ',
  filters: 'ফিল্টার',
  searchByPhoneOrMessage: 'ফোন বা মেসেজ দিয়ে অনুসন্ধান করুন',
  triggerType: 'ট্রিগার ধরন',
  allTriggers: 'সব ট্রিগার',
  allStatuses: 'সব স্ট্যাটাস',
  recipientType: 'প্রাপকের ধরন',
  clearAll: 'সব সাফ করুন',
  noMessagesFound: 'কোনো মেসেজ পাওয়া যায়নি',
  recipient: 'প্রাপক',
  trigger: 'ট্রিগার',
  message: 'মেসেজ',
  sentAt: 'পাঠানো হয়েছে',
  deleteMessageLog: 'মেসেজ লগ মুছুন',
  showing: 'দেখানো হচ্ছে',
  messages: 'মেসেজসমূহ',
  page: 'পৃষ্ঠা',

  // Messaging Metrics translations
  failedToFetchMessagingMetrics: 'মেসেজিং মেট্রিক্স আনতে ব্যর্থ',
  failedToLoadMetrics: 'মেট্রিক্স লোড করতে ব্যর্থ',
  errorLoadingMetrics: 'মেট্রিক্স লোড করতে ত্রুটি',
  noMessagingMetricsAvailable: 'কোনো মেসেজিং মেট্রিক্স উপলব্ধ নেই',
  messagingMetrics: 'মেসেজিং মেট্রিক্স',
  previousMonth: 'পূর্ববর্তী মাস',
  monthlyChange: 'মাসিক পরিবর্তন',
  vsLastMonth: 'গত মাসের তুলনায়',
  messagesByType: 'ধরন অনুযায়ী মেসেজ',
  messagesByStatus: 'স্ট্যাটাস অনুযায়ী মেসেজ',
